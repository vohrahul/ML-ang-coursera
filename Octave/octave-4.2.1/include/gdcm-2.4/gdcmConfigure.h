...
#define GDCM_SOURCE_DIR "/scratch/jwe/mxe-octave/4.2.1/w64-32/tmp-gdcm/gdcm-2.4.6"
#define GDCM_EXECUTABLE_OUTPUT_PATH "/scratch/jwe/mxe-octave/4.2.1/w64-32/tmp-gdcm/.build/bin"
#define GDCM_LIBRARY_OUTPUT_PATH    "/scratch/jwe/mxe-octave/4.2.1/w64-32/tmp-gdcm/.build/bin"
...
#define GDCM_CMAKE_INSTALL_PREFIX "/scratch/jwe/mxe-octave/4.2.1/w64-32/usr/x86_64-w64-mingw32"
